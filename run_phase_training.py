...
def get_args():
    ...
    parser.add_argument(
        "--pretrained_path",
        default="/home/diandian/Diandian/DD/PmNet/TimeSformer_divST_8x32_224_K400.pyth",
        type=str,
        metavar="Parameters",
    ...
    parser.add_argument(
        "--data_path",
        default="/home/diandian/Diandian/DD/PmNet/data/PmLR50",
        type=str,
        help="dataset path",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_dir",
        default=r"/home/diandian/Diandian/DD/PmNet/results",
